...
// PrettyJSON returns the input JSON properly indented.
...
// IsYAMLEqual compares two YAML string representations by converting them to JSON first.
...
// YAMLDiff returns the diff between two YAML string representations.
